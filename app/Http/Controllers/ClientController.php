...
class ClientController extends Controller
{
    ...
    public function AddProductToCart(Request $request){
        ...
        return redirect()->route('addtocart')->with('message', 'Produit ajouté au panier!');
    }

    public function RemoveCartItem($id){
        Cart::findOrFail($id)->delete();

        return redirect()->route('addtocart')->with('message', 'Votre produit a été supprimé !');
    }
    ...
    public function PlaceOrder(){
        ...
        return redirect()->route('pendingorders')->with('message', 'Votre commande est maintenant en attente de validation! ');
    ...
    public function ProfilePage(){
        ...
        return view('profilepage', compact('users'));
    }
