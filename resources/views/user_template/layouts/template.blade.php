...
<div class="banner_bg_main">
    ...
    <div class="logo_section">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="logo"> <p style="font-size: 75px; font-family: Pristina; color: white; ">Woody Craft</p></div>
                </div>
            </div>
        </div>
    </div>
...
<div class="footer_section layout_padding">
    <div class="container">
        <div class="footer_logo"><p style="font-size: 75px; font-family: Pristina; color: white; ">Woody Craft</p></div>

        <div class="location_main">
            <p>Nous Joindre : 0123455678</p>
