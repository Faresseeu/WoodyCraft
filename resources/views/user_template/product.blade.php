    ...
    @section('main-content')
        <div class="container">
                ...
                <div class="col-lg-8">
                   <div class="box_main">
                       <div class="product-info">
                           ...
                           <p class="price_text text-left">Prix <span style="color:#262626;">{{$product->price}} Euro</span> </p>
                       </div>
                       ...
                       <div class="btn_main">
                           <form action="{{route('addproducttocart',$product->id)}}" method="POST">
                               ...
                               <div class="form-group">
                                   ...
                                   <label for="quantity">Choisir une quantité</label>
            ...
            <div class="fashion_section">
                <div id="main_slider" >
                    <div class="container">
                        <h1 class="fashion_taital">Autres Produits</h1>
                                ...
                                <div class="col-lg-4 col-sm-4">
                                    <div class="box_main">
                                        ...
                                        <div class="btn_main">
                                            ...
                                            <div class="seemore_bt" style="position: relative; top:28px;"><a href="{{route('singleproduct',[$product->id, $product->slug])}}">Voir Plus</a></div>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
