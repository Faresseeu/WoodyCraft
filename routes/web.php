...
Route::middleware(['auth','role:user'])->group(function(){
    Route::controller(ClientController::class)->group(function(){
        ...
        Route::get('/profile-page','ProfilePage')->name('profilepage');
        Route::post('/add-product-to-cart','AddProductToCart')->name('addproducttocart');
        Route::get('/shipping-address','GetShippingAddress')->name('shippingaddress');
        Route::get('/add-shipping-address','AddShippingAddress')->name('addshippingaddress');
...
Route::middleware(['auth', 'role:admin'])->group(function(){
    ...
    Route::controller(CategoryController::class)->group(function(){
        ...
        Route::get('/admin/store-category', 'StoreCategory')->name('storecategory');
    ...
    Route::controller(SubCategoryController::class)->group(function(){
        ...
        Route::get('/admin/store-subcategory', 'StoreSubCategory')->name('storesubcategory');
        ...
        Route::get('/admin/update-subcategory', 'UpdateSubCat')->name('updatesubcat');
    });
    ...
    Route::controller(ProductController::class)->group(function(){
        ...
        Route::get('/admin/edit-product/{id}', 'EditProductImg')->name('editproductimg');
